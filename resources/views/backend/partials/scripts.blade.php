<!-- Jquery js-->
		...
		<script src="{{asset('backend/assets/plugins/datatables/JSZip/jszip.min.js')}}"></script>
		<script src="{{asset('backend/assets/plugins/datatables/pdfmake/pdfmake.min.js')}}"></script>
		<script src="{{asset('backend/assets/plugins/datatables/pdfmake/vfs_fonts.js')}}"></script>
